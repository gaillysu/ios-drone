...
- (void)setUp
{
    waterWaveHeight = self.frame.size.height/2;
    waterWaveWidth  = self.frame.size.width;
    _firstWaveColor = [UIColor colorWithRed:78/255.0 green:101/255.0 blue:214/255.0 alpha:1];
    _secondWaveColor = [UIColor colorWithRed:129/255.0f green:150/255.0f blue:248/255.0f alpha:1];
