...
let SWIFTEVENT_BUS_COCKROACHES_CHANGED:String = "SWIFTEVENT_BUS_COCKROACHES_CHANGED"

let SWIFTEVENT_BUS_COCKROACHES_DATA_UPDATED:String = "SWIFTEVENT_BUS_COCKROACHES_DATA_UPDATED"